...
#define PASSWORD_ESP "1234"
#define TIMEOUT_WIFI 5
...
extern const char *pwm_topic;
extern const char *error_topic;
extern const char *setpoint_topic;
extern const char *kp_topic;
extern const char *ki_topic;
extern const char *kd_topic;
extern const char *phone_topic;
extern const char *thresholdUpper_topic;
extern const char *thresholdLower_topic;
extern const char *thresholdOption_topic;
extern const char *alertThresholdOption_topic;
extern const char *alertThreshold_topic;
extern const char *thresholdVariation_topic;
extern const char *start_topic;
extern const char *maxPeak_topic;
extern const char *settlingTime_topic;
extern const char *overshoot_topic;

extern const char *thresholdLowerReceive_topic;
extern const char *thresholdUpperReceive_topic;
extern const char *alertThresholdOptionReceive_topic;
extern const char *setpointReceive_topic;
extern const char *phoneReceive_topic;
extern const char *thresholdOptionReceive_topic;
extern const char *thresholdVariationReceive_topic;

// Global variables
extern float Kp, Ki, Kd, SP;
extern float erro, erro1, erro2, cv, cv1, PV;
extern float Tm;
